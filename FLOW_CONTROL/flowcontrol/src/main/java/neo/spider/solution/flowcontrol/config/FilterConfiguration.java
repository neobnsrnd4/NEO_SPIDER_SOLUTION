...
import neo.spider.solution.flowcontrol.filter.ratelimiter.BucketRateLimiterFilter;
...
public class FilterConfiguration {
	...
	private final BucketRateLimiterFilter bucketRateLimiterFilter;

	public FilterConfiguration(BulkheadRegistry bulkheadRegistry, RateLimiterRegistry rateLimiterRegistry,
			TrieRegistry trieRegistry, BucketRateLimiterFilter bucketRateLimiterFilter) {
		this.bulkheadRegistry = bulkheadRegistry;
		this.rateLimiterRegistry = rateLimiterRegistry;
		this.trieRegistry = trieRegistry;
		this.bucketRateLimiterFilter = bucketRateLimiterFilter;
	}
	...
	public FilterRegistrationBean<GlobalRateLimiterFilter> globalRateLimiterFilter() {
		FilterRegistrationBean<GlobalRateLimiterFilter> registrationBean = new FilterRegistrationBean<>(
				new GlobalRateLimiterFilter(rateLimiterRegistry));
		registrationBean.addUrlPatterns("/*");
	...
	public FilterRegistrationBean<DetailRateLimiterFilter> detailRateLimiterFilter() {
		FilterRegistrationBean<DetailRateLimiterFilter> registrationBean = new FilterRegistrationBean<>(
				new DetailRateLimiterFilter(rateLimiterRegistry, trieRegistry));
		registrationBean.addUrlPatterns("/*");
	...
	public FilterRegistrationBean<PersonalRateLimiterFilter> personalRateLimiterFilter() {
		FilterRegistrationBean<PersonalRateLimiterFilter> registrationBean = new FilterRegistrationBean<>(
				new PersonalRateLimiterFilter(rateLimiterRegistry));
		registrationBean.addUrlPatterns("/*");
	...
	@Bean
	public FilterRegistrationBean<BucketRateLimiterFilter> bucket4jRateLimiterFilter() {
		FilterRegistrationBean<BucketRateLimiterFilter> registrationBean = new FilterRegistrationBean<>();
		registrationBean.setFilter(bucketRateLimiterFilter);
