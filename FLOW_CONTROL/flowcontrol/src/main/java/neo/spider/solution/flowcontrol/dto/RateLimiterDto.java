...
public class RateLimiterDto {
	...
	public String getRatelimiterMode() {
		return ratelimiterMode;
	}

	public void setRatelimiterMode(String ratelimiterMode) {
	...
	public String toString() {
		return "RateLimiterConfigDto{" + "id=" + id + ", application_id=" + application_id + ", type=" + type
				+ ", url='" + url + '\'' + ", limitForPeriod=" + limitForPeriod + ", limitRefreshPeriod="
				+ limitRefreshPeriod + ", timeoutDuration=" + timeoutDuration + '}';
	}
}
